...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<Musique> maListeDeMusiques = [
    new Musique('Misa DEL kawariano', 'Codabee', 'img/un.jpg', 'https://codabee.com/wp-content/uploads/2018/06/un.mp3'),
    new Musique('Theme Flutter de Le kawarein', 'Codabee', 'img/deux.jpg', 'https://codabee.com/wp-content/uploads/2018/06/deux.mp3'),
